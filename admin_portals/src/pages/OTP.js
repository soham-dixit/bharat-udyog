...
function OTP() {
  return (
    <div style={{ backgroundColor: "#FBF9F6" }}>
      <div className="flex items-center min-h-screen p-4 bg-white bg-gray-100">
            ...
            <main className="flex-1 items-center justify-center p-6 sm:p-12 md:w-1/2">
              <div className="w-full">
                ...
                <p className="mt-4">
                  ...
                  <button className="ml-1 text-lg font-medium text-red-600 dark:text-white-400 hover:underline">
                    Resend OTP
                  </button>
                </p>
              </div>
